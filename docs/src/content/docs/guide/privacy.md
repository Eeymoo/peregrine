...
- `code` — a stable identifier from the [REPORT_CODES registry](/guide/report-codes/) indicating the event class.
...
For the developer-facing registry of every report code, see [`REPORT_CODES.md`](/guide/report-codes/) in the repository root.
