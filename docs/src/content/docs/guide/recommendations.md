...
This page first introduces common knowledge about 3D motion sickness, then provides Peregrine reference configurations for different types of games. For a complete explanation of the principles and general mitigation methods, please read [Relieving 3D Motion Sickness](/guide/motion-sickness/) first.
