...
You can edit this file directly; the app will automatically hot-reload after you save. For where each option lives in the settings window see the [Settings Guide](/guide/settings/); for field definitions see the [Configuration Guide](/guide/config/).
