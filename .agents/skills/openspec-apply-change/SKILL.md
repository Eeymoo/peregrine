...
license: MIT
compatibility: Requires openspec CLI, the gh CLI for PR creation, and git for branch management.
metadata:
  author: openspec
  version: "1.1"
  generatedBy: "1.6.0"
...
**Guardrails**
- Create the working branch BEFORE any code change; never commit implementation work to `main`/`master`
