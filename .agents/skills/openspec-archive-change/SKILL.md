...
description: Archive a completed change in the experimental workflow. Use when the user wants to finalize and archive a change after implementation is complete and the PR has been merged.
allowed-tools: Bash(openspec:*),Bash(gh:*),Bash(git:*)
license: MIT
compatibility: Requires openspec CLI, the gh CLI for PR-merge checks, and git for the post-archive branch switch.
metadata:
  author: openspec
  version: "1.1"
  generatedBy: "1.6.0"
